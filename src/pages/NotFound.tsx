        ...
        <div className="max-w-lg w-full text-center">
          ...
          <div className="mt-10 bg-blue-50 rounded-lg border border-blue-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link to="/" className="text-sm text-blue-600 hover:text-blue-800 hover:underline font-medium px-3 py-2 rounded hover:bg-white transition-colors">
                📋 All Tasks
              </Link>
              <Link to="/login" className="text-sm text-blue-600 hover:text-blue-800 hover:underline font-medium px-3 py-2 rounded hover:bg-white transition-colors">
                🔐 Login
              </Link>
              <Link to="/register" className="text-sm text-blue-600 hover:text-blue-800 hover:underline font-medium px-3 py-2 rounded hover:bg-white transition-colors">
                ✍️ Register
              </Link>
              <Link to="/profile" className="text-sm text-blue-600 hover:text-blue-800 hover:underline font-medium px-3 py-2 rounded hover:bg-white transition-colors">
                👤 Profile
              </Link>
            </div>
          </div>
